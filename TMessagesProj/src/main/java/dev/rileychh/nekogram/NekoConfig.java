...
import dev.rileychh.nekogram.helpers.AnalyticsHelper;
import dev.rileychh.nekogram.helpers.CloudSettingsHelper;
import dev.rileychh.nekogram.helpers.LensHelper;
import dev.rileychh.nekogram.translator.Translator;
import dev.rileychh.nekogram.translator.TranslatorApps;
...
public class NekoConfig {
    ...
    public static void toggleGroupNotifications() {
        ...
        preferences.edit().putBoolean("groupNotifications", groupNotifications).apply();
    }
